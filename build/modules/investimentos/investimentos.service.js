...
exports.cadastrarInvestimentoService = void 0;
// receitas.service.ts
const mysql_connection_1 = require("../../infra/database/mysql-connection");
const dayjs_1 = __importDefault(require("dayjs"));
// Função para cadastrar uma nova receita
const cadastrarInvestimentoService = (id_cliente, descricao, valor, data_investimento, tipo) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const newDate = (0, dayjs_1.default)(data_investimento).format('YYYY-MM-DD HH:mm:ss');
...
exports.cadastrarInvestimentoService = cadastrarInvestimentoService;
